  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        ...
        <Text style={styles.infoDias}>
          <Text style={styles.weekName}>{days[coach.week_day]}</Text>
        </Text>

        <Text style={styles.weekName}>{convertMinutesToTime(coach.from)} - {convertMinutesToTime(coach.to)}</Text>
